layui.use(['form', 'layer', 'laydate', 'table', 'laytpl'], function () {
    ...
    var tableIns = table.render({
        ...
        cols: [[
            ...
            {field: 'title', title: '名称', width: 260, align: "center"},
            {field: 'price', title: '价格', align: 'center'},
            {field: 'sale_volume', title: '销量', align: 'center', templet: "#newsStatus"},
            {field: 'volume', title: '库存', align: 'center'},
            {field: 'click_number', title: '点击数', align: 'center'},
            {field: 'status', title: '状态', align: 'center', templet: "#newsStatus"},
            {
