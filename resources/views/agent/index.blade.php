...
<head>
    ...
    <link rel="stylesheet" href="{{URL::asset('agent/css/index.css')}}" media="all" />
</head>
...
<div class="layui-layout layui-layout-admin">
        ...
        <div class="layui-main mag0">
            ...
            <ul class="layui-nav top_menu">
                ...
                <li class="layui-nav-item" id="userInfo">
                    <a href="javascript:;"><img src="{{URL::asset('agent/images/face.jpg')}}" class="layui-nav-img userAvatar" width="35" height="35"><cite class="adminName">代理商</cite></a>
                    <dl class="layui-nav-child">
                        ...
                        <dd pc><a href="javascript:;" class="functionSetting"><i class="layui-icon">&#xe620;</i><cite>功能设定</cite></dd>
                        <dd pc><a href="javascript:;" class="changeSkin"><i class="layui-icon">&#xe61b;</i><cite>更换皮肤</cite></a></dd>
                        <dd><a href="agent_logout" class="signOut"><i class="seraph icon-tuichu"></i><cite>退出</cite></a></dd>
                    </dl>
                </li>
            </ul>
        </div>
    ...
    <div class="layui-side layui-bg-black">
        <div class="user-photo">
            <a class="img" title="我的头像" ><img src="{{URL::asset('agent/images/face.jpg')}}" class="userAvatar"></a>
            <p>你好！<span class="userName">代理商</span>, 欢迎登录</p>
        </div>
        <!-- 搜索 -->
        ...
        <div class="navBar layui-side-scroll" id="navBar">
            <ul class="layui-nav layui-nav-tree">
                <li class="layui-nav-item layui-this">
                    <a href="javascript:;" data-url="agent_main"><i class="layui-icon" data-icon=""></i><cite>后台首页</cite></a>
                </li>
            </ul>
        </div>
    </div>
...
<script type="text/javascript" src="{{URL::asset('agent/js/index.js')}}"></script>
