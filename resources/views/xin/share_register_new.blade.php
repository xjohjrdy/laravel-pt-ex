...
<head>
    ...
    <style>
        ...
        body {
            background: #fc3629;
            background: linear-gradient(to top, #fc1c18, #fc4735);
        }
        ...
        .register_content {
            ...
            margin: -.54rem auto 0;
            overflow: hidden;
            background: url(https://a119112.oss-cn-beijing.aliyuncs.com/%E5%8D%9E%E8%B4%A4%E9%93%83/%E5%85%AC%E7%94%A8%E6%B3%A8%E5%86%8C%E9%A1%B5/images/contentBg.png) no-repeat center top;
            background-size: 100%;
            position: relative;
            padding-bottom: .3rem;
        }
        ...
        .register_content .dd1 {
            position: absolute;
            top: 0;
            right: .1rem;
        }

        .register_content .dd1 #area-sel {
            background: url('https://putaoliulanqi1.oss-cn-zhangjiakou.aliyuncs.com/CDN/XIN/top1.png') no-repeat right center;
        ...
        .register_content .dd1 span {
            min-width: 1rem;
            height: .4rem;
            line-height: .4rem;
            border-left: 2px solid #fbdd7a;
            padding-left: 0.2rem;
            font-size: .3rem;
            color: #666;
            float: left;
        ...
        .register_content .d1 .phone,
        .register_content .d2 .pass {
            width: 100%;
            height: .75rem;
            line-height: .75rem;
            padding: 0 1.44rem 0 .3rem;
            color: #333;
            font-size: .28rem;
            background: #fff;
            margin: 0;
        ...
        .register_content .d1 .on{
            background: #999;
            color:#fff
        }

        .register_content .d2 .eyePass {
            position: absolute;
            right: .12rem;
            top: .1rem;
            width: .55rem;
            height: .55rem;
            background: url(https://a119112.oss-cn-beijing.aliyuncs.com/%E5%8D%9E%E8%B4%A4%E9%93%83/%E5%85%AC%E7%94%A8%E6%B3%A8%E5%86%8C%E9%A1%B5/images/iconEye.png) no-repeat center .14rem;
            background-size: .5rem;
        }

        .register_content .d2 .active {
        ...
        .register_content .d3 span {
            background: #f9201a url("https://a119112.oss-cn-beijing.aliyuncs.com/%E5%8D%9E%E8%B4%A4%E9%93%83/%E5%85%AC%E7%94%A8%E6%B3%A8%E5%86%8C%E9%A1%B5/images/iconsharesuccess.png") no-repeat center;
        ...
        .register_content .d3 input:checked + span {
            border-color: #fff;
            background-color: #fff;
        }

        .register_content .d3 input {
            margin: 0;
            float: left;
            opacity: 0;
            position: absolute;
        ...
        .register_content .complete {
            ...
            font-size: .38rem;
            color: #fb4529;
            background: linear-gradient(to top, #f1a16b, #fffefe);
            border-radius: .4rem;
            -moz-box-shadow: 0 .06rem .12rem rgba(226, 32, 0, .5);
            -webkit-box-shadow: 0 .06rem .12rem rgba(226, 32, 0, .5);
            box-shadow: 0 .06rem .12rem rgba(226, 32, 0, .5);
        }

        .contText {
            margin: .24rem .32rem .44rem;
            background: #fff;
            border-radius: .1rem;
        }
...
<div class="wrap">
    ...
    <div class="banner">
        <img src="https://a119112.oss-cn-beijing.aliyuncs.com/%E5%8D%9E%E8%B4%A4%E9%93%83/%E5%85%AC%E7%94%A8%E6%B3%A8%E5%86%8C%E9%A1%B5/images/banner.png"/>
    </div>
    <form id="form" action="xin_do_register" method="post">
        <div class="register_content font24">
            <div class="info">
                <!-- 没有头像图片默认显示logo -->
                <div class="img"><img src="{!! $avatar !!}" onerror="this.src='https://a119112.oss-cn-beijing.aliyuncs.com/%E5%8D%9E%E8%B4%A4%E9%93%83/common/images/logo.png'"/></div>
                <div class="text">
                    <p>{!! $user_name !!}（ID为<em id="input_value"></em>）</p>
                    <p>邀请你加入葡萄浏览器</p>
                </div>
            ...
            <div class="d1">
                <div class="dd1">
                    ...
                    <span class="font26" id="pre-code">+86</span>
                    <input name="area_code" id="area_code" hidden value="86"/>
                </div>
                <input id="mobile" type="tel" name="phone" placeholder="输入手机号码" class="phone">
            </div>
            <div class="d1">
                <input id="sms_code" type="number" name="sms_code" placeholder="输入短信验证码" class="phone">
                <a id="send_register_code" onclick="sendCode(this)" class="send">发送验证码</a>
            </div>
            <div class="d2">
                <input id="password" name="password" type="password" placeholder="请设置您的密码" class="pass">
                <div class="eyePass" onclick="showPass()"></div>
            </div>
            <!-- <div class="d2">
                <input id="confirm_password" name="confirm_password" type="password" placeholder="确认您的新密码" class="pass">
            </div> -->
            <div class="d3">
            ...
            <a id="form-submit" class="complete font30" onclick="submitForm()">立即注册</a>
        </div>
    </form>
    <div class="contText">
        <img src="https://a119112.oss-cn-beijing.aliyuncs.com/%E5%8D%9E%E8%B4%A4%E9%93%83/%E5%85%AC%E7%94%A8%E6%B3%A8%E5%86%8C%E9%A1%B5/images/contText.png"/>
    </div>
    {{--@if (isset($poster))--}}
        {{--<div class="tc_layer">--}}
...
<script>
        ...
        $.ajax({
            ...
            success: function (data) {
                if (data.code == 200) {
                    ...
                    $("#mobile, #sms_code, #password").val(""); //清空文本
                } else {
                    layer.msg(data.msg);
                }
            },
    ...
    function regCodeTimeinterval() {
        ...
        var newTime = parseInt(currTime) - 1 + "s";
        if (newTime) {
    ...
    // 密码显示隐藏
    function showPass() {
        if ($(".eyePass").hasClass("active")) {
            $("#password").attr("type", "password");
            $(".eyePass").removeClass("active");
        } else {
            $("#password").attr("type", "text");
            $(".eyePass").addClass("active");
        }

    }

    // 获取appid填充
    $('#input_value').text('{!! $show_id !!}');
