...
class AssistantServices
{
    ...
    public $appkey = '1060291713';
    public $secretKey = '90234f57-89b1-3dc1-fb18-2c3d159d63a6';
    // 生产
...
//    public $_CachePath = ITK_DATA_PATH   ;
    ...
    {
        $this->_CachePath = app_path("Library/Itaoke/request/");
    }
    ...
    public function curl($url, $postFields = null)
    {
        ...
        curl_setopt($ch, CURLOPT_REFERER, "api.36qq.com");
...
//            ));
    ...
    {
        require_once($this->_CachePath . $api_name . '.php');
        return new $api_name;
    }
}