...
namespace App\Services\TencentCloud\Common;

use \ReflectionClass;

use App\Services\TencentCloud\Common\Http\HttpConnection;
use App\Services\TencentCloud\Common\Profile\ClientProfile;
use App\Services\TencentCloud\Common\Profile\HttpProfile;
use App\Services\TencentCloud\Common\Exception\TencentCloudSDKException;


/**
 * 抽象api类，禁止client引用
 * @package App\Services\TencentCloud\Common
 */
abstract class AbstractClient
{
     ...
     * @var string SDK版本
     */
    public static $SDK_VERSION = "SDK_PHP_3.0.108";
    ...
    /**
     * @throws App\Services\TencentCloud\Common\Exception\TencentCloudSDKException
     */
