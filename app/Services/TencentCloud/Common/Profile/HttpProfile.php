...
namespace App\Services\TencentCloud\Common\Profile;

/**
 * http相关参数类
 * Class HttpProfile
 * @package App\Services\TencentCloud\Common\Profile
 */
class HttpProfile
{
     ...
     * @param string $endpoint  请求接入点域名(xx.[region.]App\Services\TencentCloudapi.com)
