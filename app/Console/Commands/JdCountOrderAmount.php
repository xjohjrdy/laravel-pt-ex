...
class JdCountOrderAmount extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'command:JdCountOrderAmount';
     ...
     * @var string
     */
    protected $description = '每月25日执行 京东分佣处理';
    ...
    public function handle()
    {
        ...
        while ($page <= $all_page) {
            ...
            foreach ($jd_maid_old_datas as $jd_maid_old_data) {
                ...
                if ($jd_maid_old_data->real == 1) {
                    continue;
                }
                $bar->advance();
                $jd_maid_old_data->update(['real' => 1]);
