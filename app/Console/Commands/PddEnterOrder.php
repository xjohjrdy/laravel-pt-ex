...
class PddEnterOrder extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'command:PddEnterOrder';
     ...
     * @var string
     */
    protected $description = '拼多多51天内的订单处理!';
    ...
    public function handle()
    {
        ...
        $start_time = date("Y-m-d H:i:s", strtotime("-51 day"));
                    ...
                    if ($bool_pdd_maid_old) {
                        if ($order_status == 1 || $order_status == 2 || $order_status == 3) {
                            ...
                            if (in_array($group_id, [23, 24])) {
                                $f_commission = round($promotion_amount * 0.00675, 2);
                            } else {
                                $f_commission = round($promotion_amount * 0.0045, 2);
                            }
