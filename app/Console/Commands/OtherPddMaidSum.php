...
class OtherPddMaidSum extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'command:OtherPddMaidSum';
     ...
     * @var string
     */
    protected $description = '第三方拼多多奖励统计';
    ...
    public function handle()
    {
        ...
        $sql = "select SUM(maid_money) AS maid_money, app_id from lc_pdd_maid_old 
        ...
        while (1) {
            ...
            foreach ($list as $key => $item) {
                try{
                    ...
                    $moneyService->plusThreeUserMoney($app_id, $money, 0, 'FPDD');
