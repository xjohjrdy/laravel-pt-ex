...
class OtherJdMaidSum extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'command:OtherJdMaidSum';
     ...
     * @var string
     */
    protected $description = '第三方京东奖励统计';
    ...
    public function handle()
    {
        ...
        $maidModel = new JdMaidOldOther();
        $sql = "select SUM(maid_money) AS maid_money, app_id from lc_jd_maid_old 
        ...
        while (1) {
            ...
            foreach ($list as $key => $item) {
                try{
                    ...
                    $moneyService->plusThreeUserMoney($app_id, $money, 0, 'FJD');
