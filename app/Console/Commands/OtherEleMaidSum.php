...
class OtherEleMaidSum extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'command:OtherEleMaidSum';
     ...
     * @var string
     */
    protected $description = '第三方饿了么奖励统计';
    ...
    public function handle()
    {
        ...
        $maidModel = new ThreeEleMaidOld();
        $sql = "select SUM(maid_money) AS maid_money, app_id from lc_ele_maid_old 
        ...
        while (1) {
            ...
            foreach ($list as $key => $item) {
                try{
                    ...
                    $moneyService->plusThreeUserMoney($app_id, $money, 0, 'ELE');
